# -*- coding: utf-8 -*-
"""
Title: Ryan Lab read rois
Concept: Altered read_roi.py file to account for ryan lab data
Created on Mon Mar 15 08:45:56 2021

@author: Andrew Nelson
based on _read_roi.py
"""
import os
import struct
import zipfile
...
def extract_basic_roi_data(data):
    ...
    roi_props = (hdr2Offset, n_coordinates, roi_type, position, version, subtype, size)
...
def read_roi_file(fpath):
    ...
    roi, (hdr2Offset, n_coordinates, roi_type, position, version, subtype, size) = extract_basic_roi_data(data)
    roi['name'] = name
...
if __name__ is '__main__':
    ...
    file = '200918 LP 50AP q1min d1K.fits'
    rois = 'RoiSet 210301 d2K NH4Cl.zip'
    zip_path = folder + rois
